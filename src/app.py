...
activities = {
    ...
    "Swim Club": {
        "description": "Develop swimming skills and prepare for swim meets",
    ...
    "Drama Club": {
        "description": "Rehearse and perform dramatic scenes and school plays",
    ...
    "Science Olympiad": {
        "description": "Prepare for science competitions covering physics, chemistry, and biology",
        "schedule": "Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["ava@mergington.edu", "evelyn@mergington.edu"]
    }
}
